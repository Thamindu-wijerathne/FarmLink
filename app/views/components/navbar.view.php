<div style="background-color: #333; overflow: hidden; padding: 10px 0;">
    <a 
        href="#" 
        style="float: left; color: white; text-decoration: none; padding: 14px 20px; text-align: center; margin-left: 5px;" 
    ...
    <a 
        href="#" 
        style="float: left; color: white; text-decoration: none; padding: 14px 20px; text-align: center;" 
        onmouseover="this.style.backgroundColor='#575757'; this.style.color='white';" 
        onmouseout="this.style.backgroundColor='transparent'; this.style.color='white';">
        About
    </a>
